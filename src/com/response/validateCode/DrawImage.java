...
public class DrawImage extends HttpServlet {
    ...
    private String drawRandomNum(Graphics2D g, String... createTypeFlag) {
        ...
        String baseNumLetter = "0123456789ABCDEFGHJKLMNOPQRSTUVWXYZ";// 数字和字母的组合
        String baseNum = "0123456789";// 纯数字
        String baseLetter = "ABCDEFGHJKLMNOPQRSTUVWXYZ";// 纯字母
        ...
        if (createTypeFlag.length > 0 && null != createTypeFlag[0]) {
            ...
            return createRandomChar(g, baseNumLetter);// 默认截取数字和字母的组合
        }
